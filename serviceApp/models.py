...
class songShare(models.Model):
    ...
    share_from = models.ForeignKey(userInf, related_name='share_from_user', on_delete=models.CASCADE)
    share_to = models.ForeignKey(userInf, related_name='share_to_user', on_delete=models.CASCADE)
    share_song = models.ForeignKey(songsInf, related_name='share_song', on_delete=models.CASCADE)
...
class songCommit(models.Model):
    commit_id = models.AutoField(primary_key=True, null=False)
    commit_song = models.ForeignKey(songsInf, related_name='commit_song', on_delete=models.CASCADE)
    commit_user = models.ForeignKey(userInf, related_name='commit_user', on_delete=models.CASCADE)
...
class songLikes(models.Model):
    ...
    like_user = models.ForeignKey(userInf, related_name='like_user', on_delete=models.CASCADE)
    like_song = models.ForeignKey(songsInf, related_name='like_song', on_delete=models.CASCADE)
