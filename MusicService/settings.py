...
SECRET_KEY = '^n1h+d-jo&!&+m@x4!cjh(g8d48fj&^i+5)nqs6k%y&ce(*s!='
...
DATABASES = {
    ...
    #    'PASSWORD': db_info["PASSWORD"].decode('utf-8'),
    #    'SEVER': db_info["HOST"].decode('utf-8'),
    #    'PORT': db_info["PORT"].decode('utf-8'),
    #}
}
