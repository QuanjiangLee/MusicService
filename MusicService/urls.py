...
urlpatterns = [
    ...
    url(r'^adminIndex/home/$', views.home),
    url(r'^index/phones_list/$', views.phones_list),
    url(r'^userIndex/phones_list/$', views.phones_list),
    url(r'^adminIndex/phones_list/$', views.phones_list),
